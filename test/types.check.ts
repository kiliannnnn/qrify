 ...
 */
import { encode, toSVG, toCanvas, maxBytes, isFinder, ECC_LEVELS } from '../core.js';
import { defineQrify, getQrifyElement } from '../index.js';
import type { EccLevel, EncodeResult, RenderOptions, SvgOptions } from '../core.js';
...
void [dark, side, version, level, bytes, svg, minimal, transparent, limit, corner, levels, scale, pixels, registered, cls, svgOnly];
